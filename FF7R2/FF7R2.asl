state("ff7rebirth_", "EGS1")
{
	...
	bool load2 : "ff7rebirth_.exe", 0x8F925D4; //1 at the start of loads
...
state("ff7rebirth_", "EGS2")
{
	...
	bool load2 : "ff7rebirth_.exe", 0x9221260;
...
state("ff7rebirth_", "Steam2")
{
	...
	bool load2 : "ff7rebirth_.exe", 0x8FEA2F8;
...
init
{
	...
	if (modules.First().ModuleMemorySize == 161677312)
		version = "EGS2";

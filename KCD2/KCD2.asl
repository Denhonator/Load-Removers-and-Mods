...
state("KingdomCome", "1.3")
{
	bool load : "WHGame.DLL", 0x54A0B00, 0x60; //1 or 0
	bool fade : "WHGame.DLL", 0x5348360, 0x1A0, 0x18; //1 or 0
	bool fasttime : "WHGame.DLL", 0x536A358; //0xFFFFFFFF or 0
	int quest : "WHGame.DLL", 0x54A3328, 0x18, 0x11F0, 0x30; //0 for first quest, +1 per quest
}

state("KingdomCome", "1.3.1")
{
	bool load : "WHGame.DLL", 0x54A0BC0, 0x60; //1 or 0
	bool fade : "WHGame.DLL", 0x5348360, 0x1A0, 0x18; //1 or 0
	bool fasttime : "WHGame.DLL", 0x536A358; //0xFFFFFFFF or 0
	int quest : "WHGame.DLL", 0x54A34C8, 0x18, 0x11F0, 0x30; //0 for first quest, +1 per quest
}

state("KingdomCome", "1.3.2")
{
	bool load : "WHGame.DLL", 0x54A0AF0, 0x60; //1 or 0
	bool fade : "WHGame.DLL", 0x5348360, 0x1A0, 0x18; //1 or 0
	bool fasttime : "WHGame.DLL", 0x536A358; //0xFFFFFFFF or 0
	int quest : "WHGame.DLL", 0x54A3410, 0x18, 0x11F0, 0x30; //0 for first quest, +1 per quest
}

state("KingdomCome", "1.5.1")
{
	bool load : "WHGame.DLL", 0x5486B20, 0x60; //1 or 0
	bool fade : "WHGame.DLL", 0x532E480, 0x1A0, 0x18; //1 or 0
	bool fasttime : "WHGame.DLL", 0x5350458; //0xFFFFFFFF or 0
...
init
{
	...
	if(vars.memsize == 95584256)
		...
		version = "1.3.2";
	else if(vars.memsize == 95793152)
		version = "1.3.1";
	else if(vars.memsize == 95801344)
		version = "1.3";
	else if(vars.memsize == 94892032)
		version = "1.2.4";
